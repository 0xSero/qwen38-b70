...
MTP_CONFIG='{"method":"qwen3_5_mtp","num_speculative_tokens":3,"model":"/model"}'

exec vllm serve /model \
  --dtype float16 --max-model-len 4096 --gpu-memory-utilization 0.75 \
  --tensor-parallel-size 2 --max-num-seqs 10 --max-num-batched-tokens 4096 \
