...
MTP_CONFIG='{"method":"qwen3_5_mtp","num_speculative_tokens":8,"model":"/model"}'

exec vllm serve /model \
  --dtype float16 --max-model-len 4096 --gpu-memory-utilization 0.60 \
  --tensor-parallel-size 2 --max-num-seqs 8 --max-num-batched-tokens 2048 \
